---
title: "Effective Visualizations in R"
...
1. **'tidyverse'** is for overall data handling. It contains **'ggplot2'** with other required packages like **'dplyr'**. 
...
```{r load_pack, message=FALSE, warning=FALSE, paged.print=FALSE}
library(tidyverse)
library(ggalt)
library(GGally)
library(ggridges)
...
# note : write your own directory where you saved the csv files. make sure to change '\' by '/' !
...
#### View Datasets
```{r view, message=FALSE, warning=FALSE, paged.print=FALSE}
View(data_iris)
View(data_diamonds)
View(data_names)
View(data_life_exp)
